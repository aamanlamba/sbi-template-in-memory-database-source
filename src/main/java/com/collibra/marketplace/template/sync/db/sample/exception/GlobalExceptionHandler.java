 ...
 */
package com.collibra.marketplace.template.sync.db.sample.exception;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Exceptions thrown during the execution of the application will be caught in this method.
     *
