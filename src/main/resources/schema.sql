...
/**
 TALEND DATA QUALITY METRICS DATABASE. SCHEMA AND TABLES CREATION:
**/

CREATE SCHEMA talend_dq;
USE talend_dq;

/* Table: TDQ_INDICATOR_VALUE */
CREATE TABLE TDQ_INDICATOR_VALUE (
  INDV_PK              INT(11) NOT NULL,
  INDV_INT_VALUE       INT(11),
  INDV_ROW_COUNT       INT(11),
  INDV_ITHRESH_OK      CHAR(1),
  INDV_ITHRESH_LOW     BIGINT(20),
  INDV_ITHRESH_HI      BIGINT(20),
  AN_RUNTIME           DATETIME,
  ELEMENT_PK           INT(11),
  INDICATOR_PK         INT(11),
  ANALYSIS_PK          INT(11),
...
/* Table: TDQ_ANALYSIS */
CREATE TABLE TDQ_ANALYSIS (
  AN_PK           INT(11) NOT NULL,
  AN_TYPE         VARCHAR(100),
  PRIMARY KEY (AN_PK)
);

/* Table: TDQ_INDICATOR_DEFINITION */
CREATE TABLE TDQ_INDICATOR_DEFINITION (
  IND_PK               INT(11) NOT NULL,
  IND_LABEL            VARCHAR(255),
  IND_CATEGORY         VARCHAR(255),
  PRIMARY KEY (IND_PK)
);

/* Table: TDQ_ANALYZED_ELEMENT */
CREATE TABLE TDQ_ANALYZED_ELEMENT (
  ELT_PK                INT(11) NOT NULL,
  ELT_CATALOG_NAME      VARCHAR(255),
  ELT_TABLE_NAME        VARCHAR(255),
  ELT_COLUMN_NAME       VARCHAR(255),
  PRIMARY KEY (ELT_PK)
);

/**
 SYSTEMS-APPS-DATABASES DATABASE. SCHEMA AND TABLES CREATION:
**/

CREATE SCHEMA systems_applications_databases;
USE systems_applications_databases;


/* Table: SYSTEM_APP_DB */
CREATE TABLE SYSTEM_APP_DB (
  ID        INT(11) NOT NULL,
  NAME      VARCHAR(255),
  TYPE      VARCHAR(255),
  PRIMARY KEY (ID)
