...
/**
 TALEND DATA QUALITY METRICS DATABASE. DATA INSERTION:
**/

USE talend_dq;

/* TDQ_INDICATOR_VALUE */
INSERT INTO `TDQ_INDICATOR_VALUE` (`INDV_PK`, `INDV_INT_VALUE`, `INDV_ROW_COUNT`, `INDV_ITHRESH_OK`, `INDV_ITHRESH_LOW`, `INDV_ITHRESH_HI`, `AN_RUNTIME`, `ELEMENT_PK`, `INDICATOR_PK`, `ANALYSIS_PK`) VALUES 
      (4, 5, 0, 'Y', 0.0, 6.0, '2019-02-10', 1, 4, 2)
     ,(10, 3, 0, 'Y', 1.0, 5.0, '2015-05-11', 3, 4, 2)
     ,(11, 3, 3, 'Y', 0.0, 10.0, '2014-08-08', 1, 1, 1)
     ,(12, 0, 3, 'Y', 0.0, 0.0, '2016-02-10', 1, 2, 1)
     ,(13, 0, 0, 'Y', 0.0, 0.0, '2016-02-10', 2, 3, 1)
     ,(14, 3, 3, 'Y', 0.0, 7.0, '2019-02-10', 5, 1, 4);

/* TDQ_ANALYSIS */
INSERT INTO `TDQ_ANALYSIS` (`AN_PK`, `AN_TYPE`) VALUES
      (1, 'MULTIPLE_COLUMN')
      ,(2, 'MULTIPLE_COLUMN')
      ,(4, 'TABLE');

/* TDQ_INDICATOR_DEFINITION */
INSERT INTO `TDQ_INDICATOR_DEFINITION` (`IND_PK`, `IND_LABEL`, `IND_CATEGORY`) VALUES
      (1, 'Row Count', 'Simple Statistics')
      ,(2, 'Duplicate Count', 'Simple Statistics')
      ,(3, 'Null Count', 'Simple Statistics')
      ,(4, 'Unique Count', 'Simple Statistics');

/* TDQ_ANALYZED_ELEMENT */
INSERT INTO `TDQ_ANALYZED_ELEMENT` (`ELT_PK`, `ELT_CATALOG_NAME`, `ELT_TABLE_NAME`, `ELT_COLUMN_NAME`) VALUES
      (1, 'h2-test', 'results', 'ID')
      ,(2, 'h2-test', 'results', 'NAME')
      ,(3, 'h2-test', 'results', 'ID_MANAGER')
      ,(5, 'h2-test', 'results', 'N/A (TDQ)');
      
      
/**
 SYSTEMS-APPS-DATABASES DATABASE. DATA INSERTION:
**/
USE systems_applications_databases;

/* SYSTEM_APP_DB */
INSERT INTO `SYSTEM_APP_DB` (`ID`, `NAME`, `TYPE`) VALUES 
     (1,'Northwind Sample Database', 'Database')
     ,(2,'Talend Data Quality Physical Data Model','Database')
     ,(3,'Reservation Mobile App','Application')
     ,(4,'Payroll System','System')
     ,(5,'Jira','System')
     ,(6,'GitHub','System')
     ,(7,'Reservation API','Application')
     ,(8,'Customer API','Application')
     ,(9,'Reservation Database','Database')
     ,(10,'Customer Database','Database')
     ,(11,'Customer Mobile App','Application')
     ,(12,'Payroll Mobile App','Application');